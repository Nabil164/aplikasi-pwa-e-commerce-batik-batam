...
export async function GET(request) {
  try {
    ...
    console.error('[GET ADDRESSES] Error message:', error.message);
    console.error('[GET ADDRESSES] Error stack:', error.stack);
    return NextResponse.json(
      { 
        status: false, 
...
export async function POST(request) {
  try {
    ...
    console.error('[CREATE ADDRESS] Error message:', error.message);
    console.error('[CREATE ADDRESS] Error stack:', error.stack);
    return NextResponse.json(
      { 
        status: false, 
        message: 'Internal Server Error',
